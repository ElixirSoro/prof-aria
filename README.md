...
| **Streaming** | La réponse s'affiche au fil de la génération ; le bloc JSON de fin n'est jamais rendu à l'écran. |
...
assets/js/app.js                  auth, séance en flux SSE, profil, export
